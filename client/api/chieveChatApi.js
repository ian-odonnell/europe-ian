...
chieveChatApi.postMessage = async (personaId, messageBody, parentMessageId) => {
  return await chieveChatApi.post("/api/message", { personaId, body: messageBody, parentId: parentMessageId });
}
