...
var _fs = __webpack_require__(491);
...
var _sequelize = __webpack_require__(259);
...
var models = [__webpack_require__(492), __webpack_require__(493), __webpack_require__(494), __webpack_require__(495), __webpack_require__(496), __webpack_require__(497), __webpack_require__(498), __webpack_require__(499)];
...
var chieveChatApi = new _externalApi.ExternalApi(_config2.default.localApiBaseUrl);
console.log("Test: " + _config2.default.localApiBaseUrl);
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return chieveChatApi.get("/api/latest");
...
chieveChatApi.getAuth = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return chieveChatApi.get("/auth");
...
chieveChatApi.postMessage = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(messageBody, parentMessageId) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return chieveChatApi.post("/api/message", { body: messageBody, parentId: parentMessageId });
...
var _chieveChatApi = __webpack_require__(97);
...
var _chatActions = __webpack_require__(138);
...
var ChatHeader = function (_React$Component) {
  ...
  function ChatHeader(props, context) {
    _classCallCheck(this, ChatHeader);

    var _this = _possibleConstructorReturn(this, (ChatHeader.__proto__ || Object.getPrototypeOf(ChatHeader)).call(this, props, context));

    _this.state = { selectedPersona: undefined };
    return _this;
  }
  ...
  _createClass(ChatHeader, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_userPanel2.default, { selectedPersona: this.state.selectedPersona })
      );
    }
  }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ChatHeader);
...
function postMessage(messageBody, parentMessageId) {
  return function (dispatch) {
    _chieveChatApi2.default.postMessage(messageBody, parentMessageId).then(function () {
      dispatch(hidePopup());
    });
  };
}
...
var ChatFeed = function (_React$Component) {
  ...
  function ChatFeed(props, context) {
    _classCallCheck(this, ChatFeed);

    var _this = _possibleConstructorReturn(this, (ChatFeed.__proto__ || Object.getPrototypeOf(ChatFeed)).call(this, props, context));
  ...
  _createClass(ChatFeed, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _chieveChatApi2.default.getChat();

              case 2:
                latestChat = _context.sent;
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.state.chat[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
exports.createMessage = function (messageData, transaction) {
  var txn = !!transaction ? { transaction: transaction } : {};
  return models.message.create(messageData, txn);
};

exports.getAllRootMessages = function () {
  return new Promise(function (resolve) {
...
exports.getUsers = function (where, include) {
  return new Promise(function (resolve) {
    var allUsers = models.user.findAll({ where: where, include: include });
    resolve(allUsers);
  });
};
...
var _passport = __webpack_require__(135);
...
var _configureStore = __webpack_require__(484);

var _configureStore2 = _interopRequireDefault(_configureStore);

var _reactRedux = __webpack_require__(69);

var _chat = __webpack_require__(490);

var _chat2 = _interopRequireDefault(_chat);

var _admin = __webpack_require__(500);

var _admin2 = _interopRequireDefault(_admin);

var _update = __webpack_require__(501);

var _update2 = _interopRequireDefault(_update);

var _auth = __webpack_require__(508);

var _auth2 = _interopRequireDefault(_auth);

var _GoogleUser = __webpack_require__(509);

var _GoogleUser2 = _interopRequireDefault(_GoogleUser);

var _Persona = __webpack_require__(98);
...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } // 3rd party
...
var GoogleStrategy = __webpack_require__(510).OAuth2Strategy;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _GoogleUser2.default.getGoogleUsers({ googleId: profile.id });
...
var MSSQLStore = __webpack_require__(511)(_expressSession2.default);
var sqlConfig = {
...
var renderPage = function renderPage() {
  return _react2.default.createElement(_chatPage2.default, null);
};
...
var _chatHeader = __webpack_require__(136);

var _chatHeader2 = _interopRequireDefault(_chatHeader);

var _chatFeed = __webpack_require__(139);
...
var ChatPage = function (_React$Component) {
  ...
  _createClass(ChatPage, [{
    ...
    key: 'render',
    value: function render() {
      var popup = this.props.message.showPopup ? _react2.default.createElement(_postDialog2.default, { hidePopup: this.props.hidePopup, postMessage: this.props.postMessage }) : undefined;
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    hidePopup: function hidePopup() {
      return dispatch(chatActions.hidePopup());
    },
    postMessage: function postMessage(messageBody, parentMessageId) {
      return dispatch(chatActions.postMessage(messageBody, parentMessageId));
    }
  };
}
...
exports.ExternalApi = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _urlJoin = __webpack_require__(137);
...
var ExternalApi = exports.ExternalApi = function () {
  function ExternalApi(baseUrl) {
    _classCallCheck(this, ExternalApi);
...
exports.default = function (props) {
  ...
  buttons.push(_react2.default.createElement(_chatFilterButton2.default, { key: 4, filterName: 'steam', buttonLabel: 'Steam', showMessages: props.filters.showSteam, changeFilter: props.changeFilter }));
...
exports.default = function (props) {
  var toggleClass = props.showMessages ? "filterButtonShow" : "filterButtonHide";

  return _react2.default.createElement(
    'td',
    { onClick: function onClick() {
        return props.changeFilter(props.filterName, !props.showMessages);
...
var UserPanel = function (_React$Component) {
  ...
  function UserPanel(props, context) {
    _classCallCheck(this, UserPanel);

    return _possibleConstructorReturn(this, (UserPanel.__proto__ || Object.getPrototypeOf(UserPanel)).call(this, props, context));
  }
...
var ChatMessage = function (_React$Component) {
  ...
  _createClass(ChatMessage, [{
    ...
    value: function render() {
      ...
      var chatMessageGame = undefined;
      if (this.props.message.achievement && this.props.message.gameRows) {
        chatMessageGame = _react2.default.createElement(_chatMessageGame2.default, { game: this.props.message.achievement.game, rowcount: this.props.message.gameRows });
      }
...
var PostDialog = function (_React$Component) {
  _inherits(PostDialog, _React$Component);

  function PostDialog(props, context) {
    _classCallCheck(this, PostDialog);

    var _this = _possibleConstructorReturn(this, (PostDialog.__proto__ || Object.getPrototypeOf(PostDialog)).call(this, props, context));

    _this.state = {};
    return _this;
  }

  _createClass(PostDialog, [{
    key: 'componentDidMount',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this2.props.postMessage(_reactDom2.default.findDOMNode(_this2.refs.messageBody).value, 23);
              } },
            'Submit'
          )
        )
...
var _reduxImmutableStateInvariant = __webpack_require__(488);
...
var _filterReducer = __webpack_require__(486);

var _filterReducer2 = _interopRequireDefault(_filterReducer);

var _messageReducer = __webpack_require__(487);
...
function filterReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { showWow: true, showDiablo: true, showOverwatch: true, showSteam: true };
...
function messageReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { showPopup: true };
  var action = arguments[1];
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _models2.default.achievementView.findAll();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _models2.default.message.findAll({
              ...
              include: [{
                ...
                include: [{
                  model: _models2.default.game
                }]
              }, {
                model: _models2.default.message,
                as: 'replies',
          ...
          case 8:
            ...
            res.status(500).send(JSON.stringify(_context2.t0));
...
module.exports = function (sequelize, DataTypes) {
  ...
  AchievementView.sync = function () {
    Promise.resolve();
  };
  AchievementView.drop = function () {
    Promise.resolve();
  };
...
var _requestPromise = __webpack_require__(261);
...
var _steamApi = __webpack_require__(502);

var _steamApi2 = _interopRequireDefault(_steamApi);

var _Achievement = __webpack_require__(505);

var _Achievement2 = _interopRequireDefault(_Achievement);

var _Game = __webpack_require__(506);
...
var _SteamUser = __webpack_require__(507);
...
router.get('/steam', function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res, next) {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 21:
            ...
            _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop(recentGame) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 11:
                      ...
                      _context2.next = 14;
                      return _models2.default.achievementView.findAll({ where: { gameId: dbGame.id, personaId: steamUser.personaId } });
                    ...
                    case 21:
                      ...
                      return _context2.delegateYield(_loop2(earnedAchievement), 't0', 24);
              ...
              }, _loop, _this, [[19, 29, 33, 41], [34,, 36, 40]]);
            });
          ...
          case 29:
            ...
            return _context3.delegateYield(_loop(recentGame), 't0', 32);
    ...
    }, _callee, this, [[0, 69], [14, 54, 58, 66], [27, 37, 41, 49], [42,, 44, 48], [59,, 61, 65]]);
  }));
...
var _externalApi = __webpack_require__(503);

var _baseUrl = __webpack_require__(504);
...
steamApi.getGameAchievements = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(steamUserId, steamAppId) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return steamApi.get('/ISteamUserStats/GetPlayerAchievements/v0001/?key=' + apiKey + '&steamid=' + steamUserId + '&appid=' + steamAppId);
...
steamApi.getGameSchema = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(steamAppId) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return steamApi.get('/ISteamUserStats/GetSchemaForGame/v0001/?key=' + apiKey + '&appid=' + steamAppId);
...
var ExternalApi = exports.ExternalApi = function () {
  ...
  _createClass(ExternalApi, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                options = {
                  uri: (0, _urlJoin2.default)(this.baseUrl, relativeUrl),
                  headers: {
                    'User-Agent': 'Request-Promise'
                  },
                  json: true
    ...
    key: 'put',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(relativeUrl, body) {
        var options;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    key: 'delete',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(relativeUrl) {
        var options;
...
function getBaseUrl(externalApiName) {
  var env = process.env.NODE_ENV || "development";

  if (process.argv.some(function (a) {
    return a.indexOf("_mocha") > -1;
  })) {
  ...
  /* eslint-disable no-constant-condition */
      ...
      var externalUrls = {
        "steam": _config2.default.steamApiBaseUrl
      };
...
exports.createAchievement = function (achievementData, transaction) {
  var txn = !!transaction ? { transaction: transaction } : {};
  return models.achievement.create(achievementData, txn);
};

exports.getAllKnownAchievementsForGame = function (appId) {
  return new Promise(function (resolve) {
...
var passport = __webpack_require__(135);
var router = express.Router();

router.get('/', function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var lookUpUser, loggedInUser;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _User2.default.getUsers();

          case 4:
            _context.t0 = _context.sent[0].id;
            lookUpUser = {
              id: _context.t0
            };
          ...
          case 6:
            ...
            _context.next = 9;
            return _User2.default.getUsers({ id: lookUpUser.id }, [{ model: _models2.default.persona }]);
...
exports.createGoogleUser = function (googleUserData, transaction) {
  var txn = !!transaction ? { transaction: transaction } : {};
  return models.googleuser.create(googleUserData, txn);
};

exports.getGoogleUsers = function (where) {
  return new Promise(function (resolve) {
    var allUsers = models.googleuser.findAll({ where: where });
    resolve(allUsers);
  });
};
